...
<div style="border-left: 4px solid #2196F3; padding-left: 10px; margin: 10px 0;">
  ...
  <ol>
    <li>
    Enabling this format is easier from a configuration file. See the Tips & Tricks section.
    </li>
    <li>
...
!!! note
    ...
    *Passing large metadata objects can hurt the performance of logging if done in a loop/hot path. Only use “metadata” logging for debug messages, since the debug level is usually switched off in production code.*
